...
<body>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu @if(Route::is('admin.customer*')) pcoded-trigger active @endif" dropdown-icon="style1" subitem-icon="style1">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="{{route('admin.customer.list')}}">
                                                <span class="pcoded-mtext">Customer Wake Up</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>

                                <li class="pcoded-hasmenu @if(Route::is('admin.room-ability*')) pcoded-trigger active @endif" dropdown-icon="style1" subitem-icon="style1">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-direction-alt"></i></span>
                                        <span class="pcoded-mtext">Room Ability</span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="@if(Route::is('admin.room-ability.facility')) active @endif">
                                            <a href="{{route('admin.room-ability.facility')}}">
                                                <span class="pcoded-mtext">Facility</span>
                                            </a>
                                        </li>
                                        <li class="@if(Route::is('admin.room-ability.bedList')) active @endif">
                                            <a href="{{route('admin.room-ability.bedList')}}">
                                ...
                                <li class="pcoded-hasmenu @if(Route::is('admin.room-settings*')) pcoded-trigger active @endif" dropdown-icon="style1" subitem-icon="style1">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-layers-alt"></i></span>
                                        <span class="pcoded-mtext">Room Settings</span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="@if(Route::is('admin.room-settings.floorList')) active @endif">
                                            <a href="{{route('admin.room-settings.floorList')}}">
                                                <span class="pcoded-mtext">Floor List</span>
                                            </a>
                                        </li>
                                        <li class="@if(Route::is('admin.room-settings.roomCategory')) active @endif">
                                            <a href="{{route('admin.room-settings.roomCategory')}}">
                                                <span class="pcoded-mtext">Room Category</span>
                                            </a>
                                        </li>
                                        <li class="@if(Route::is('admin.room-settings.couponCode')) active @endif">
                                            <a href="{{route('admin.room-settings.couponCode')}}">
    ...
    <!-- amchart js -->
    <script src="{{url('/')}}/assets/admin/assets\pages\widget\amchart\amcharts.js"></script>
    <script src="{{url('/')}}/assets/admin/assets\pages\widget\amchart\serial.js"></script>
    <script src="{{url('/')}}/assets/admin/assets\pages\widget\amchart\light.js"></script>
    <script src="{{url('/')}}/assets/admin/assets\js\jquery.mCustomScrollbar.concat.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/admin/assets\js\SmoothScroll.js"></script>
    <script src="{{url('/')}}/assets/admin/assets\js\pcoded.min.js"></script>
    <!-- custom js -->
    <script src="{{url('/')}}/assets/admin/assets\js\vartical-layout.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/admin/assets\js\script.min.js"></script>
