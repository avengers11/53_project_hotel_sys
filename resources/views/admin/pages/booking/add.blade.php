...
@section('master')
    ...
    <form action="{{route('admin.booking.bookingAddNew.view')}}" method="post">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                        ...
                        <div class="card-block pl-0 pr-0 pt-0">
                            <form action="{{route('admin.service.serviceAdd')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="total_night" placeholder="Total night input field" value="00" required/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="max_adults" placeholder="Max adults input field" value="00" required/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="max_children" placeholder="Max children input field" value="00" required/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <select name="user_id" class="selectpicker form-control bg-light border" placeholder="Old customer" data-live-search="true">
                                        ...
                                        <table id="add-row-table" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="add-row-table_info">
                                            ...
                                            <tbody id="assign_payment_wrapper">
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="datetime-local" name="payment_dates[]">
                                                    </td>
                                                    <td>
        ...
        $(document).ready(function(){
            ...
            $("#assign_new_activity").click(function(){
                ...
                <tr role="row" class="odd">
                    ...
                    <td>5</td>
                    <td>3 Days</td>
                    <td><input class="form-control" name="activity_dates[]" type="datetime-local"></td>
            ...
            $("#assign_new_payment").click(function(){
                ...
                <tr role="row" class="odd">
                    ...
                    <td><input type="text" style="width: 150px" name="payment_trxs[]" class="form-control"></td>
                    <td><input type="text" style="width: 80px" name="payment_amounts[]" class="form-control fee_amount"></td>
                    <td>
                        <button type="button" class="btn close-btn label label-danger rounded"><i class="mr-0 ti-trash"></i></button>
                    </td>
                </tr>
            ...
            $("tbody").on('input', '.tax_rat', function(){
                let feeAmount = $(this).closest('tr').find('.fee_amount').val();
                let tax = $(this).val();
