...
@section('master')
    ...
    <div class="page-body">
        ...
        <x-PageStart  header="All Services List"/>

        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-block">
                        <a href="{{route('admin.service.serviceAdd.view')}}" class="btn btn-success m-b-20 text-light"><i class="ti-plus"></i>Add New</a>
                                            ...
                                            <tbody>
                                                @foreach ($dataType as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>{{$item->price}}</td>
                                                        <td>
                                                            <x-Action type="delete" href="{{route('admin.service.serviceDelete', $item)}}" />
                                                            <x-Action type="edit" href="{{route('admin.service.serviceUpdate.view', $item)}}" />
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
