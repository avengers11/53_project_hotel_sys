                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="wizard2">
                                        <section>
                                            <form class="wizard-form" id="verticle-wizard" action="{{route('admin.customer.update', $user)}}" method="POST">
                                                @csrf
                                                ...
                                                <fieldset>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="fname-22" name="fname" value="{{$user->fname}}" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="lname-22" name="lname" value="{{$user->lname}}" type="text" class=" form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="Email-22" name="email" value="{{$user->email}}" type="email" class="form-control ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="number-22" name="number" value="{{$user->number}}" type="number" class="form-control ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                ...
                                                <fieldset>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <textarea name="address" value="{{$user->address}}" id="" cols="30" rows="5" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">Select Country</div>
                                                        <div class="col-sm-12">
                                                            <select class="form-control required" name="country" value="{{$user->country}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="City-22" name="city" value="{{$user->city}}" type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="Postcode-22" name="postcode" value="{{$user->postcode}}" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                <h3> Final </h3>
                                                <fieldset>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="Profession-22" name="profession" value="{{$user->profession}}" type="text" class="form-control required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="Company-22" name="company" value="{{$user->company}}" type="text" class="form-control required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input id="Position-22" name="position" value="{{$user->position}}" type="text" class="form-control required">
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </form>
