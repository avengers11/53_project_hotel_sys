...
@section('master')
    @push('style')
        <!-- Required Fremwork -->
        <link rel="stylesheet" type="text/css" href="{{url('/assets/admin/')}}/bower_components\font-awesome\css\font-awesome.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="{{url('/assets/admin/')}}/assets\icon\themify-icons\themify-icons.css">
        <!-- ico font -->
        <link rel="stylesheet" type="text/css" href="{{url('/assets/admin/')}}/assets\icon\icofont\css\icofont.css">
        <!-- feather Awesome -->
        <link rel="stylesheet" type="text/css" href="{{url('/assets/admin/')}}/assets\icon\feather\css\feather.css">
    @endpush
                        ...
                        <div class="col-lg-12">
                            <div class="cover-profile">
                                <div class="profile-bg-img">
                                    <img class="profile-bg-img img-fluid" src="{{url('/assets/admin/')}}/assets\images\user-profile\bg-img1.jpg" alt="bg-img">
                                    <div class="card-block user-info">
                                        <div class="col-md-12">
                                            <div class="media-left">
                                                <a href="#" class="profile-image">
                                                    <img class="user-img img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\user-img.jpg" alt="user-img">
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <div class="card">
                                                <div class="card-header contact-user">
                                                    <img class="img-radius img-40" src="{{url('/assets/admin/')}}/assets\images\avatar-4.jpg" alt="contact-user">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <div class="connection-list">
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-1.jpg" alt="f-1" data-toggle="tooltip" data-placement="top" data-original-title="Airi Satou">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-2.jpg" alt="f-2" data-toggle="tooltip" data-placement="top" data-original-title="Angelica Ramos">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-3.jpg" alt="f-3" data-toggle="tooltip" data-placement="top" data-original-title="Ashton Cox">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-4.jpg" alt="f-4" data-toggle="tooltip" data-placement="top" data-original-title="Cara Stevens">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-5.jpg" alt="f-5" data-toggle="tooltip" data-placement="top" data-original-title="Garrett Winters">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-1.jpg" alt="f-6" data-toggle="tooltip" data-placement="top" data-original-title="Cedric Kelly">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-3.jpg" alt="f-7" data-toggle="tooltip" data-placement="top" data-original-title="Brielle Williamson">
                                                        </a>
                                                        <a href="#"><img class="img-fluid img-radius" src="{{url('/assets/admin/')}}/assets\images\user-profile\follower\f-5.jpg" alt="f-8" data-toggle="tooltip" data-placement="top" data-original-title="Jena Gaines">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-block">
                                            <ul class="media-list">
                                                <li class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img class="media-object img-radius comment-img" src="{{url('/assets/admin/')}}/assets\images\avatar-1.jpg" alt="Generic placeholder image">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        ...
                                                        <div class="media mt-2">
                                                            <a class="media-left" href="#">
                                                                <img class="media-object img-radius comment-img" src="{{url('/assets/admin/')}}/assets\images\avatar-2.jpg" alt="Generic placeholder image">
                                                            </a>
                                                            <div class="media-body">
                                                                ...
                                                                <div class="media mt-2">
                                                                    <div class="media-left">
                                                                        <a href="#">
                                                                            <img class="media-object img-radius comment-img" src="{{url('/assets/admin/')}}/assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                                                        </a>
                                                                    </div>
                                                                    <div class="media-body">
                                                        ...
                                                        <div class="media mt-2">
                                                            <a class="media-left" href="#">
                                                                <img class="media-object img-radius comment-img" src="{{url('/assets/admin/')}}/assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                                            </a>
                                                            <div class="media-body">
                                                                <h6 class="media-heading">Larry heading <span class="f-12 text-muted m-l-5">Just now</span></h6>
                                                                <div class="stars-example-css review-star">
    ...
    @push('script')
        ...
        <script type="text/javascript" src="{{url('/assets/admin/')}}/bower_components\bootstrap-datepicker\js\bootstrap-datepicker.min.js"></script>
        ...
        <!-- ck editor -->
        <script src="{{url('/assets/admin/')}}/assets\pages\ckeditor\ckeditor.js"></script>
        <!-- echart js -->
        <script src="{{url('/assets/admin/')}}/assets\pages\chart\echarts\js\echarts-all.js" type="text/javascript"></script>
        <!-- i18next.min.js -->
        ...
        <script src="{{url('/assets/admin/')}}/assets\pages\user-profile.js"></script>
